...
def cos():
    ...
    for i in range(len(top)):
        path = "../baseline/findcollision/result/Top/top"+str(top[i])+".csv"
...
def cpp():
    ...
    for i in range(len(top)):
        path = "../baseline/CPP/result/Top/top"+str(top[i])+".csv"
